...
hold all
fill_transparent(get(gca,'xlim'),[-2e-3 0],'r')
...
fill_transparent(get(gca,'xlim'),[2 2.1],'r')
...
set(ax(axNum),'Ytick',[0,1,2,3,4,5,6,7])
set(ax(axNum),'Yticklabels',{'0','2','4','8','16','32','64','128'})
